...
namespace Teste.TestesHistorico
{
    class UC19_ExcluirHistorico
    {
        ...
        [Test]
        public void CT01UC19_Excluir_dadosRelacionados_comSucesso()
        {
            Assert.IsTrue(historicoDAO.Excluir(historicoInicial.Id));
        }
    }
}
